...
export default function InventoryDashboard() {
  ...
  return (
    <section
      ref={containerRef}
      className="snap-start flex justify-center items-center min-h-screen px-4 md:px-0"
    >
      <div className="w-[300px] h-[515px] md:w-[360px] bg-white rounded-2xl shadow-2xl overflow-hidden flex flex-col justify-between">
        {/* Header */}
            ...
            <div className="px-4 py-2">
              ...
              <ul className="mt-2 space-y-1 text-sm">
                {inventoryData.map((item) => (
                  <li key={item.id} className={item.stock < item.min ? 'text-red-500' : 'text-green-600'}>
